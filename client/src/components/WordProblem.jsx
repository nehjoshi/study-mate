    ...
    return (
        <div className={styles.wrapper}>
            ...
            <div className={styles.optionsWrapper}>
                ...
                <input type="checkbox" value={question.option1} className={styles.input} checked={answer===question.option1} onChange={e => setAnswer(e.target.value.toString())}/>
                <label className={styles.label}>{question.option2}</label>
                <input type="checkbox" value={question.option2} className={styles.input} checked={answer===question.option2} onChange={e => setAnswer(e.target.value.toString())}/>
                <label className={styles.label}>{question.option3}</label>
                <input type="checkbox" value={question.option3} className={styles.input} checked={answer===question.option3} onChange={e => setAnswer(e.target.value.toString())}/>
                <label className={styles.label}>{question.option4}</label>
                <input type="checkbox" value={question.option4} className={styles.input} checked={answer===question.option4} onChange={e => setAnswer(e.target.value.toString())}/>
            </div>
        </div>
    )
}
