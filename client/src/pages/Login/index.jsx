            ...
            <div className={styles.box}>
                <h1 className={styles.heading}>Sign In</h1>
                    <div className={styles.form}>
                        ...
                        <TextField onChange={e => setEmail(e.target.value)} type="email" required  label="Email" variant="outlined" fullWidth /><br /><br />
                        <TextField onChange={e => setPassword(e.target.value)} type="password" required  label="Password" variant="outlined" fullWidth />
